...
package() {
  ...
  install -Dm644 "$srcdir/kwimy-hypr/system/colors/matugen.conf" "$pkgdir/usr/share/kwimy-hypr/colors/matugen.conf"
  install -Dm644 "$srcdir/kwimy-hypr/system/colors/colors.conf" "$pkgdir/usr/share/kwimy-hypr/colors/colors.conf"
